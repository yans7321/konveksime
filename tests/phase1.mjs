...
function makeDriver() {
  ...
  return {
    async query(text, params = []) {
      ...
      if (/SELECT name FROM yans_migrations/.test(t)) return [{ name: "0001_foundation_tables" }, { name: "0002_jobs" }, { name: "0003_tailoring_pickups" }, { name: "0004_storages" }, { name: "0006_ledger_modules" }];
